...
export function StayConnected({ variant }: Props) {
  const [follow, setFollow] = useState(256);
  const [like, setLike] = useState(512);
  const [subscriber, setSubscriber] = useState(1024);
  ...
  const handleSubscriber = () => {
    if (isSubscriber) {
      ...
      setSubscriber((prevState) => prevState + 1);
    }
  };
  ...
  return (
    <div className="relative mb-6">
      ...
      <div className="flex justify-start items-center mb-4">
        <div className="py-2 px-2 mr-4 rounded-md text-white font-semibold bg-blue-500">
          <svg
      ...
      {/* Instagram */}
      <div className="flex justify-start items-center mb-4">
        <span className="py-2 px-2 mr-4 rounded-md text-white font-semibold bg-gradient-to-tr from-pink-500 to-indigo-600">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
        ...
        <div className="flex justify-between items-center w-full">
          ...
          <button
            className={`font-bold text-xs cursor-pointer duration-300 ${
              isLike
                ? "text-white px-2 py-1 bg-gradient-to-tr from-pink-500 to-indigo-600 rounded-md"
                : ""
            }`}
            onClick={handleLike}
          >
      ...
      {/* Utube */}
      <div className="flex justify-start items-center mb-4">
        <span className="py-2 px-2 mr-4 rounded-md text-white font-semibold bg-red-500">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="16"
            height="16"
        ...
        <div className="flex justify-between items-center w-full">
          ...
          <button
            className={`font-bold text-xs cursor-pointer duration-300 ${
              isSubscriber ? "text-white px-2 py-1 bg-red-500 rounded-md" : ""
            }`}
